...
export WANDB_API_KEY='14094be1295a320463cde7a6970604869dac3985'
...
EXPERIMENT_NAME='openvla_worldgym_bridge_oft_ckpt20k_5chunk_split'
RESUME_CKPT=''
SFT_MODEL_NAME="openvla-oft-bridge-sft-20000"
SFT_MODEL_PATH="/projects/work/yang-lab2/as20482/checkpoints/SimpleVLA-RL/$SFT_MODEL_NAME"
CKPT_PATH="/projects/work/yang-lab2/as20482/checkpoints/SimpleVLA-RL"
